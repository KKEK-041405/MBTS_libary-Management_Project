...
<input type="password" name="password" placeholder="SetNewPassword" required><br><br>
<label for="ConfrimPass">Confrim Password</label>
<input type="password" name="ConfrimPass" placeholder="Confrim Password" required><br>
